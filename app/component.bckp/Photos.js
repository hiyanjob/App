...
render(){
    ...
    return (
      ...
      <View style={{  flexDirection: 'row',marginTop:55,marginLeft:0}}> 
        ...
        <ImageBackground source={require('./images/2.png')} style={{width:'100%',marginLeft:1, height:300,marginTop:0,marginBottom: 15}} >
        <View style={{  flexDirection: 'row',marginTop:15,marginLeft:-5}}>
      ...
      <View style={{  flexDirection: 'row',marginTop:145,marginLeft:-60}}> 
       ...
       <Image source={require('./images/addButton.png')} 
         style={{width: 80, height: 90,marginTop:-30,justifyContent: 'flex-end',alignSelf:'flex-end',marginLeft:4,marginRight:4}} />  
        </ImageBackground>       
      </View>
