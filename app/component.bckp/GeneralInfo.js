...
render(){
  ...
  const religionData = this.createData2();
   const maritalData = this.createData3();
    ...
    return (
      <ScrollView>
      <View style={{justifyContent:'center',alignItems:'center',marginLeft:'-11%',backgroundColor:'#FFFFFF'}} >
       <View style={{width:'80%',flex: 1, marginTop:19,marginLeft:'9%', justifyContent: 'center'}}>
         ...
         thumbTintColor='#fbfbfb'
          ...
          <View 
          style=
          {{flexDirection:'row',marginTop:-18,justifyContent:'space-between',alignItems:'center',paddingHorizontal:1}}>
          <View style={styles.container4}>
           ...
           <View style={styles.container5}>
             <Dropdown containerStyle={{width:140,height:50}}
                 placeholder='Year'
                 placeholderTextColor="#8788A1"
                data={yearArr}
           ...
           <TextInput style = {{borderBottomWidth:1, borderColor:'#ccc',width:375, height:50,marginLeft:"27%",marginRight:"20%",marginTop:5}}
               placeholder = "Degree"
               placeholderTextColor="#8788A1"
               autoCapitalize = "none"
               returnKeyType="next"
            ...
            <TouchableOpacity
             ...
             <TextInput style = {{borderBottomWidth:1, borderColor:'#ccc',width:375, height:50,marginLeft:"27%",marginRight:"20%",marginTop:5,fontWeight:"bold"}}
