    ...
    return (
      ...
      <View style={{alignItems: 'center'}}>
       ...
       <Image source={require('./images/google.png')} style={{width:70,marginLeft:11, height:75,marginBottom: 15}} />
        ...
        <FontAwesomeIcon style={{justifyContent:'center',textAlign:'center',alignItems:'center',marginTop:37}}
              name='caret-right'
              size={28}
              color='#fff'/>  
      ...
      <View style={{  flexDirection: 'row',marginTop:55,marginLeft:0}}> 
        ...
        <ImageBackground source={require('./images/cof.png')} style={{width:'100%',marginLeft:1, height:300,marginTop:0,marginBottom: 5}} >
        <View style={{  flexDirection: 'row',marginTop:15,marginLeft:-5}}>
