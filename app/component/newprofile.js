...
import {
  AppRegistry, Dimensions, Button,
  PixelRatio, Platform,
  Text, StatusBar, Picker, View, CheckBox, Image, ImageBackground, StyleSheet, TextInput, TouchableOpacity, Alert, AsyncStorage, ScrollView
} from 'react-native';
    ...
    return (
      <ScrollView>
        <View style={styles.container}>
          ...
          <LinearGradient start={{ x: 0, y: 0.75 }} end={{ x: 1, y: 0.25 }} colors={['#2682d8', '#2493d0','#21aec5']} >
            <View  >
              <Image
                style={{ marginLeft: 40, height: 15, width: 20, marginTop: 20 }}
                source={require('./images/back.png')}
              />
              <Text style={{ textAlign: 'center', marginTop: -20, color: 'white' }}> Profile </Text>
          ...
          <Picker 
            ...
            onValueChange = {this.city1}>
              ...
              <RadioForm
                ...
                labelStyle={{
                  marginBottom: 10, paddingRight: 30, textAlign: 'center',
                }}
                buttonColor={'#2196f3'}
                animation={true}
              ...
              <View>
                ...
                <View style={{
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <CheckBox style={{ justifyContent: "flex-end", marginLeft: "62%", marginTop: 15 }}
                      checkedColor='#4889f2'
